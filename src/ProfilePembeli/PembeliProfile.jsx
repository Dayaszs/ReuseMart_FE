...
import { Card, Pagination, Tabs, TabItem } from "flowbite-react";
import { PulseLoader } from 'react-spinners';
import DaftarAlamat from './DaftarAlamat';
import { getProfilePicturePembeli } from '@/api';
    ...
    return (
        <Card className="w-full bg-white/90 backdrop-blur-md p-6">
            ...
            <Tabs aria-label="Tabs with underline" variant="underline">
                <TabItem active title="Daftar Pemesanan">
                    {/* Container Daftar pemesanan */}
                    <div>
